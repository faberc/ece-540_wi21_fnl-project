...
#
# Generated by export_simulation on Mon Feb 22 16:52:48 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './PmodBLE_0.sh' script.

./PmodBLE_0.sh -reset_run
...
./PmodBLE_0.sh -noclean_files

For more information on the script, please type './PmodBLE_0.sh -help'.
