...
HD_PWD='C:/Users/Chuck/RVfpga/vivado/project_final/project_final.runs/PmodBLE_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodBLE_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodBLE_0.tcl
