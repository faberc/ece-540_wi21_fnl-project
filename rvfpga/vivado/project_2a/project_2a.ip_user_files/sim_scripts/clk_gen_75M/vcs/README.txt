...
#
# Generated by export_simulation on Sat Feb 06 14:17:09 -0800 2021
#
################################################################################
...
'-reset_run' switch to the './clk_gen_75M.sh' script.

./clk_gen_75M.sh -reset_run
...
./clk_gen_75M.sh -noclean_files

For more information on the script, please type './clk_gen_75M.sh -help'.
